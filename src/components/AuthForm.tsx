...
export const AuthForm = ({ onSuccess }: AuthFormProps) => {
  ...
  const roleBadges = {
    free: { label: 'Free', variant: 'secondary' as const, description: 'Basic features' },
    pro: { label: 'Pro', variant: 'default' as const, description: 'Advanced features' },
    team: { label: 'Team', variant: 'success' as const, description: 'Team collaboration' }
  }
      ...
      <Card className="w-full max-w-md shadow-elevated bg-gradient-card border-border/50">
        <CardHeader className="space-y-1">
          <div className="text-center mb-6">
            <h1 className="text-4xl font-bold text-foreground mb-2">SlipStream</h1>
            <p className="text-muted-foreground">Real Estate Commission Tracker</p>
          </div>
